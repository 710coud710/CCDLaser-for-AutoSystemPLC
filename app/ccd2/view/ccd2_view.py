"""
CCD2 View - Giao diện riêng cho CCD2
Hiển thị ảnh từ camera CCD2 và thông tin trạng thái
"""
import logging
import numpy as np
import cv2
...
class CCD2View(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._init_ui()
        logger.info("CCD2View initialized")
    
    def _init_ui(self):
        """Khởi tạo giao diện CCD2"""
        ...
        # Info label
        self.info_label = QLabel("CCD2: Not started")
        ...
        self.btn_start = QPushButton("Start CCD2")
        self.btn_start.clicked.connect(self.start_requested.emit)
        control_layout.addWidget(self.btn_start)
        
        self.btn_stop = QPushButton("Stop CCD2")
        ...
        self.status_text.setPlaceholderText("CCD2 status messages...")
    ...
    def update_status(self, status: str):
        ...
        self.info_label.setText(f"CCD2: {text}")
